...
public class Main2Activity_Nivel1 extends AppCompatActivity {
    ...
    private MediaPlayer mp, mp_gread, mp_bad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 1 - Suma basica", Toast.LENGTH_SHORT).show();

        tv_nombre = (TextView)findViewById(R.id.textView_nombre);
        tv_score = (TextView)findViewById(R.id.textView_score);
        iv_vidas = (ImageView)findViewById(R.id.imageView_vidas);
        iv_Auno = (ImageView)findViewById(R.id.imageViewNumUno);
        ...
        mp_gread = MediaPlayer.create(this, R.raw.wonderful);
           ...
           if (resultado == respuesta_jugador){
               ...
               switch (vidas){
                   ...
                   case 1:
                       ...
                       break;
                   case 0:
                       Toast.makeText(this, "Te quedaste sin manzana", Toast.LENGTH_SHORT).show();
